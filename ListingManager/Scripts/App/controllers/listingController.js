    ...
    */
    ...
    app.controller("listingCtrl", ["$scope", "commonData", "listingService", "agentService", function ($scope, commonData, listingService, agentService) {
        ...
        $scope.addListingItem = function () {
            //var scope = this;
            var addItem = { ListingId: $scope.ListingId, ListingName: $scope.ListingName, ListingAddress: $scope.ListingAddress, AgentId: $scope.AgentId.AgentId, AgentName: $scope.AgentName };
        ...
        $scope.clear = function () {
            $scope.ListingId = 0;$scope.ListingName = ""; $scope.ListingAddress = ""; $scope.AgentId = "";
        };
